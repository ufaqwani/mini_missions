...
cd mission-tracker 2>/dev/null || cd .
...
cat > backend/database/addUserIds.js << 'EOF'
...
echo "🔐 Step 2: Creating directories and authentication system..."
